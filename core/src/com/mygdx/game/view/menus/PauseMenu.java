...
import com.mygdx.game.view.buttons.ResumeButton;
import com.mygdx.game.view.buttons.SoundButton;
...
public class PauseMenu extends Group {
    ...
    private static final int BUTTONS_ALIGN = 10;
    ...
    public PauseMenu(GameScreen screen) {
        ...
        buttons = new Table();
        buttons.add(resumeButton).padRight(BUTTONS_ALIGN);
